...
#'   hca_api_call() functions, taking in API call parameters and returning a
#'   response
#'
...
#'
#' @return list() response headers and content from call, error message output
#' if needed
#' @export
hca_base_call <- function(
                r_filter = list(),

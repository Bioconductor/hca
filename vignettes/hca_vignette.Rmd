...
# Example: Exploring manifest files
Manifest files aggregate metadata on files into a tabular format. Here, we wish
to have the metadata for all `.loom` files generated by either version 4.2.2 or
4.2.3 of the Optimus pipeline, coming from the project with the ID

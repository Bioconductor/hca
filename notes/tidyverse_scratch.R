...
## Tidyverse
## Motivation: a subset of R functions that work together and preform certain
## regular tasks in a uniform way i.e. dataframe manipulation
...
## tibble is a flavor of a dataframe, but it displays dimensions and truncates
## output automatically and other features
...
## tidyverse also gives us pipes for passing outputs from one action is the
## input for another > makes output the first input of the following function
...
## non-standard evaluation allows you to use unquoted variables
## to reference tibble columns
...
## Good tidyverse functions take as their first object the data
## to be transformed, and return the same class as